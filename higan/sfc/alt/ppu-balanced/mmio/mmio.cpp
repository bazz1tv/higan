//INIDISP
auto PPU::mmio_w2100(buint8 value) -> void {
...
//OBSEL
auto PPU::mmio_w2101(buint8 value) -> void {
...
//BGMODE
auto PPU::mmio_w2105(buint8 value) -> void {
...
//MOSAIC
auto PPU::mmio_w2106(buint8 value) -> void {
...
//BG1VOFS
auto PPU::mmio_w210e(buint8 value) -> void {
...
//VMADDL
auto PPU::mmio_w2116(buint8 value) -> void {
...
//VMADDH
auto PPU::mmio_w2117(buint8 value) -> void {
...
//VMDATAL
auto PPU::mmio_w2118(buint8 value) -> void {
  buint16 addr = get_vram_address();
...
//VMDATAH
auto PPU::mmio_w2119(buint8 value) -> void {
...
//M7SEL
auto PPU::mmio_w211a(buint8 value) -> void {
...
//M7A
auto PPU::mmio_w211b(buint8 value) -> void {
  regs.m7a      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//M7B
auto PPU::mmio_w211c(buint8 value) -> void {
  regs.m7b      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//M7C
auto PPU::mmio_w211d(buint8 value) -> void {
  regs.m7c      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//M7D
auto PPU::mmio_w211e(buint8 value) -> void {
  regs.m7d      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//M7X
auto PPU::mmio_w211f(buint8 value) -> void {
  regs.m7x      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//M7Y
auto PPU::mmio_w2120(buint8 value) -> void {
  regs.m7y      = (value << 8) | regs.m7_latch;
  regs.m7_latch = value;
}

//CGADD
auto PPU::mmio_w2121(buint8 value) -> void {
...
//this on hardware.
auto PPU::mmio_w2122(buint8 value) -> void {
...
//W12SEL
auto PPU::mmio_w2123(buint8 value) -> void {
...
//W34SEL
auto PPU::mmio_w2124(buint8 value) -> void {
...
//WOBJSEL
auto PPU::mmio_w2125(buint8 value) -> void {
...
//WH0
auto PPU::mmio_w2126(buint8 value) -> void {
  regs.window1_left = value;
}

//WH1
auto PPU::mmio_w2127(buint8 value) -> void {
  regs.window1_right = value;
}

//WH2
auto PPU::mmio_w2128(buint8 value) -> void {
  regs.window2_left = value;
}

//WH3
auto PPU::mmio_w2129(buint8 value) -> void {
  regs.window2_right = value;
}

//WBGLOG
auto PPU::mmio_w212a(buint8 value) -> void {
...
//WOBJLOG
auto PPU::mmio_w212b(buint8 value) -> void {
  regs.window_mask[COL] = (value >> 2) & 3;
  regs.window_mask[OAM] = (value     ) & 3;
}

//TM
auto PPU::mmio_w212c(buint8 value) -> void {
...
//TS
auto PPU::mmio_w212d(buint8 value) -> void {
...
//TMW
auto PPU::mmio_w212e(buint8 value) -> void {
...
//TSW
auto PPU::mmio_w212f(buint8 value) -> void {
...
//CGWSEL
auto PPU::mmio_w2130(buint8 value) -> void {
...
//CGADDSUB
auto PPU::mmio_w2131(buint8 value) -> void {
...
//COLDATA
auto PPU::mmio_w2132(buint8 value) -> void {
...
//SETINI
auto PPU::mmio_w2133(buint8 value) -> void {
