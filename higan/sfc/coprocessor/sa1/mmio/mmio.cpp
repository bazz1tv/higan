//(CCNT) SA-1 control
auto SA1::mmio_w2200(buint8 data) -> void {
...
auto SA1::mmio_w2201(buint8 data) -> void {
...
auto SA1::mmio_w2202(buint8 data) -> void {
...
auto SA1::mmio_w2203(buint8 data) -> void { mmio.crv = (mmio.crv & 0xff00) | data; }
auto SA1::mmio_w2204(buint8 data) -> void { mmio.crv = (data << 8) | (mmio.crv & 0xff); }

//(CNV) SA-1 NMI vector
auto SA1::mmio_w2205(buint8 data) -> void { mmio.cnv = (mmio.cnv & 0xff00) | data; }
auto SA1::mmio_w2206(buint8 data) -> void { mmio.cnv = (data << 8) | (mmio.cnv & 0xff); }

//(CIV) SA-1 IRQ vector
auto SA1::mmio_w2207(buint8 data) -> void { mmio.civ = (mmio.civ & 0xff00) | data; }
auto SA1::mmio_w2208(buint8 data) -> void { mmio.civ = (data << 8) | (mmio.civ & 0xff); }

//(SCNT) S-CPU control
auto SA1::mmio_w2209(buint8 data) -> void {
...
auto SA1::mmio_w220a(buint8 data) -> void {
...
auto SA1::mmio_w220b(buint8 data) -> void {
...
auto SA1::mmio_w220c(buint8 data) -> void { mmio.snv = (mmio.snv & 0xff00) | data;      }
auto SA1::mmio_w220d(buint8 data) -> void { mmio.snv = (data << 8) | (mmio.snv & 0xff); }

//(SIV) S-CPU IRQ vector
auto SA1::mmio_w220e(buint8 data) -> void { mmio.siv = (mmio.siv & 0xff00) | data;      }
auto SA1::mmio_w220f(buint8 data) -> void { mmio.siv = (data << 8) | (mmio.siv & 0xff); }

//(TMC) H/V timer control
auto SA1::mmio_w2210(buint8 data) -> void {
...
auto SA1::mmio_w2211(buint8 data) -> void {
  status.vcounter = 0;
  status.hcounter = 0;
}

//(HCNT) H-count
auto SA1::mmio_w2212(buint8 data) -> void { mmio.hcnt = (mmio.hcnt & 0xff00) | (data << 0); }
auto SA1::mmio_w2213(buint8 data) -> void { mmio.hcnt = (mmio.hcnt & 0x00ff) | (data << 8); }

//(VCNT) V-count
auto SA1::mmio_w2214(buint8 data) -> void { mmio.vcnt = (mmio.vcnt & 0xff00) | (data << 0); }
auto SA1::mmio_w2215(buint8 data) -> void { mmio.vcnt = (mmio.vcnt & 0x00ff) | (data << 8); }

//(CXB) Super MMC bank C
auto SA1::mmio_w2220(buint8 data) -> void {
  mmio.cbmode = (data & 0x80);
  mmio.cb     = (data & 0x07);
}

//(DXB) Super MMC bank D
auto SA1::mmio_w2221(buint8 data) -> void {
  mmio.dbmode = (data & 0x80);
  mmio.db     = (data & 0x07);
}

//(EXB) Super MMC bank E
auto SA1::mmio_w2222(buint8 data) -> void {
  mmio.ebmode = (data & 0x80);
  mmio.eb     = (data & 0x07);
}

//(FXB) Super MMC bank F
auto SA1::mmio_w2223(buint8 data) -> void {
  mmio.fbmode = (data & 0x80);
  mmio.fb     = (data & 0x07);
}

//(BMAPS) S-CPU BW-RAM address mapping
auto SA1::mmio_w2224(buint8 data) -> void {
  mmio.sbm = (data & 0x1f);
}

//(BMAP) SA-1 BW-RAM address mapping
auto SA1::mmio_w2225(buint8 data) -> void {
  mmio.sw46 = (data & 0x80);
  mmio.cbm  = (data & 0x7f);
}

//(SWBE) S-CPU BW-RAM write enable
auto SA1::mmio_w2226(buint8 data) -> void {
  mmio.swen = (data & 0x80);
}

//(CWBE) SA-1 BW-RAM write enable
auto SA1::mmio_w2227(buint8 data) -> void {
  mmio.cwen = (data & 0x80);
}

//(BWPA) BW-RAM write-protected area
auto SA1::mmio_w2228(buint8 data) -> void {
  mmio.bwp = (data & 0x0f);
}

//(SIWP) S-CPU I-RAM write protection
auto SA1::mmio_w2229(buint8 data) -> void {
  mmio.siwp = data;
}

//(CIWP) SA-1 I-RAM write protection
auto SA1::mmio_w222a(buint8 data) -> void {
  mmio.ciwp = data;
}

//(DCNT) DMA control
auto SA1::mmio_w2230(buint8 data) -> void {
...
auto SA1::mmio_w2231(buint8 data) -> void {
...
auto SA1::mmio_w2232(buint8 data) -> void { mmio.dsa = (mmio.dsa & 0xffff00) | (data <<  0); }
auto SA1::mmio_w2233(buint8 data) -> void { mmio.dsa = (mmio.dsa & 0xff00ff) | (data <<  8); }
auto SA1::mmio_w2234(buint8 data) -> void { mmio.dsa = (mmio.dsa & 0x00ffff) | (data << 16); }

//(DDA) DMA destination start address
auto SA1::mmio_w2235(buint8 data) -> void {
  mmio.dda = (mmio.dda & 0xffff00) | (data <<  0);
}

auto SA1::mmio_w2236(buint8 data) -> void {
...
auto SA1::mmio_w2237(buint8 data) -> void {
...
auto SA1::mmio_w2238(buint8 data) -> void { mmio.dtc = (mmio.dtc & 0xff00) | (data << 0); }
auto SA1::mmio_w2239(buint8 data) -> void { mmio.dtc = (mmio.dtc & 0x00ff) | (data << 8); }

//(BBF) BW-RAM bitmap format
auto SA1::mmio_w223f(buint8 data) -> void {
  mmio.bbf = (data & 0x80);
}

//(BRF) bitmap register files
auto SA1::mmio_w2240(buint8 data) -> void { mmio.brf[ 0] = data; }
auto SA1::mmio_w2241(buint8 data) -> void { mmio.brf[ 1] = data; }
auto SA1::mmio_w2242(buint8 data) -> void { mmio.brf[ 2] = data; }
auto SA1::mmio_w2243(buint8 data) -> void { mmio.brf[ 3] = data; }
auto SA1::mmio_w2244(buint8 data) -> void { mmio.brf[ 4] = data; }
auto SA1::mmio_w2245(buint8 data) -> void { mmio.brf[ 5] = data; }
auto SA1::mmio_w2246(buint8 data) -> void { mmio.brf[ 6] = data; }
auto SA1::mmio_w2247(buint8 data) -> void { mmio.brf[ 7] = data;
  if(mmio.dmaen == true) {
...
auto SA1::mmio_w2248(buint8 data) -> void { mmio.brf[ 8] = data; }
auto SA1::mmio_w2249(buint8 data) -> void { mmio.brf[ 9] = data; }
auto SA1::mmio_w224a(buint8 data) -> void { mmio.brf[10] = data; }
auto SA1::mmio_w224b(buint8 data) -> void { mmio.brf[11] = data; }
auto SA1::mmio_w224c(buint8 data) -> void { mmio.brf[12] = data; }
auto SA1::mmio_w224d(buint8 data) -> void { mmio.brf[13] = data; }
auto SA1::mmio_w224e(buint8 data) -> void { mmio.brf[14] = data; }
auto SA1::mmio_w224f(buint8 data) -> void { mmio.brf[15] = data;
  if(mmio.dmaen == true) {
    if(mmio.cden == 1 && mmio.cdsel == 0) {
      dma_cc2();
    }
...
auto SA1::mmio_w2250(buint8 data) -> void {
  mmio.acm = (data & 0x02);
  mmio.md  = (data & 0x01);
...
auto SA1::mmio_w2254(buint8 data) -> void {
  ...
  if(mmio.acm == 0) {
    if(mmio.md == 0) {
      ...
      if(mmio.mb == 0) {
        ...
        int16  quotient  = (int16)mmio.ma / (buint16)mmio.mb;
        buint16 remainder = (int16)mmio.ma % (buint16)mmio.mb;
...
auto SA1::mmio_w2258(buint8 data) -> void {
  mmio.hl = (data & 0x80);
  mmio.vb = (data & 0x0f);
...
auto SA1::mmio_w2259(buint8 data) -> void { mmio.va = (mmio.va & 0xffff00) | (data <<  0); }
auto SA1::mmio_w225a(buint8 data) -> void { mmio.va = (mmio.va & 0xff00ff) | (data <<  8); }
auto SA1::mmio_w225b(buint8 data) -> void { mmio.va = (mmio.va & 0x00ffff) | (data << 16); mmio.vbit = 0; }

//(SFR) S-CPU flag read
auto SA1::mmio_r2300() -> buint8 {
  buint8 data;
...
auto SA1::mmio_r2303() -> buint8 {
  return mmio.hcr >> 8;
}

//(VCR) vcounter read
auto SA1::mmio_r2304() -> buint8 { return mmio.vcr >> 0; }
auto SA1::mmio_r2305() -> buint8 { return mmio.vcr >> 8; }

//(MR) arithmetic result
auto SA1::mmio_r2306() -> buint8 { return mmio.mr >>  0; }
auto SA1::mmio_r2307() -> buint8 { return mmio.mr >>  8; }
auto SA1::mmio_r2308() -> buint8 { return mmio.mr >> 16; }
auto SA1::mmio_r2309() -> buint8 { return mmio.mr >> 24; }
auto SA1::mmio_r230a() -> buint8 { return mmio.mr >> 32; }

//(OF) arithmetic overflow flag
auto SA1::mmio_r230b() -> buint8 { return mmio.overflow << 7; }

//(VDPL) variable-length data read port low
auto SA1::mmio_r230c() -> buint8 {
  buint32 data = (vbr_read(mmio.va + 0) <<  0)
...
auto SA1::mmio_r230e() -> buint8 {
  return 0x01;  //true value unknown
}

auto SA1::mmio_read(uint24 addr, buint8) -> buint8 {
...
auto SA1::mmio_write(uint24 addr, buint8 data) -> void {
  (co_active() == cpu.thread ? cpu.synchronizeCoprocessors() : synchronizeCPU());
  addr &= 0xffff;
