...
auto SDD1::read(uint24 addr, buint8 data) -> buint8 {
  addr = 0x4800 | (addr & 7);
...
auto SDD1::write(uint24 addr, buint8 data) -> void {
  addr = 0x4800 | (addr & 7);
...
auto SDD1::dma_read(uint24 addr, buint8 data) -> buint8 {
  return cpu.dmaPortRead(addr, data);
}

auto SDD1::dma_write(uint24 addr, buint8 data) -> void {
...
auto SDD1::mmc_read(uint24 addr) -> buint8 {
...
auto SDD1::mcurom_read(uint24 addr, buint8) -> buint8 {
...
auto SDD1::mcurom_write(uint24 addr, buint8 data) -> void {
}

//map address=00-3f,80-bf:6000-7fff mask=0xe000
//map address=70-7d:0000-7fff mask=0x8000
auto SDD1::mcuram_read(uint24 addr, buint8 data) -> buint8 {
  return ram.read(addr & 0x1fff, data);
}

auto SDD1::mcuram_write(uint24 addr, buint8 data) -> void {
