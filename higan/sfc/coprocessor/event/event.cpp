...
auto Event::mcuRead(uint24 addr, buint8 data) -> buint8 {
...
auto Event::mcuWrite(uint24 addr, buint8 data) -> void {
}

auto Event::read(uint24 addr, buint8 data) -> buint8 {
...
auto Event::write(uint24 addr, buint8 data) -> void {
