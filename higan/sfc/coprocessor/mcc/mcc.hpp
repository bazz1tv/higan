...
struct MCC {
  ...
  auto memory_access(bool write, Memory& memory, uint24 addr, buint8 data) -> buint8;
  auto mcu_access(bool write, uint24 addr, buint8 data) -> buint8;

  auto mcu_read(uint24 addr, buint8 data) -> buint8;
  auto mcu_write(uint24 addr, buint8 data) -> void;
