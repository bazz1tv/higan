...
auto SuperFX::CPUROM::read(uint24 addr, buint8 data) -> buint8 {
  if(superfx.regs.sfr.g && superfx.regs.scmr.ron) {
    static const buint8 vector[16] = {
...
auto SuperFX::CPUROM::write(uint24 addr, buint8 data) -> void {
...
auto SuperFX::CPURAM::read(uint24 addr, buint8 data) -> buint8 {
  if(superfx.regs.sfr.g && superfx.regs.scmr.ran) return data;
  return superfx.ram.read(addr, data);
}

auto SuperFX::CPURAM::write(uint24 addr, buint8 data) -> void {
