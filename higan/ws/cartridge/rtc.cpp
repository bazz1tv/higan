...
auto Cartridge::rtcStatus() -> buint8 {
  return 0x80;
}

auto Cartridge::rtcCommand(buint8 data) -> void {
  rtc.command = data;
...
auto Cartridge::rtcRead() -> buint8 {
  buint8 data = 0;

  static auto encode = [](buint8 data) -> buint8 {
...
auto Cartridge::rtcWrite(buint8 data) -> void {
  static auto decode = [](buint8 data) -> buint8 {
