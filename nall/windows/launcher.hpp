...
auto launch(const char* applicationName, const char* libraryName, buint32 entryPoint) -> bool {
  ...
  buint8 entryData[1024], entryHook[1024] = {
  ...
  entryHook[1] = (buint8)((entryPoint + 14) >>  0);
  entryHook[2] = (buint8)((entryPoint + 14) >>  8);
  entryHook[3] = (buint8)((entryPoint + 14) >> 16);
  entryHook[4] = (buint8)((entryPoint + 14) >> 24);

  auto pLoadLibraryW = (buint32)GetProcAddress(GetModuleHandleW(L"kernel32"), "LoadLibraryW");
